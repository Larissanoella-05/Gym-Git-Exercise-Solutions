...
git push
git checkout master
git remote add origin https://github.com/Larissanoella-05/git-exercise-clone.git
git remote add git-copy https://github.com/Larissanoella-05/git-exercise-clone.git
git remote
git status
git add .
git commit -m"changes in home"
git push origin
git push git-copy
git status
git pull
...
git status
git add .
git commit -m"created footer page"
git push
git push --set-upstream origin ft/footer
git add .
git status
git commit -m"changes in footer page"
git push
git checkout master
